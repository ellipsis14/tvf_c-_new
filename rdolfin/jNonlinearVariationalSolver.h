...
#ifndef __jNONLINEAR_VARIATIONAL_SOLVER_H
#define __jNONLINEAR_VARIATIONAL_SOLVER_H
...
namespace dolfin
{
  ...
  class jNonlinearVariationalSolver : public Variable
  {
  public:

    /// Create nonlinear variational solver for given problem
    explicit jNonlinearVariationalSolver(std::shared_ptr<NonlinearVariationalProblem> problem);
    ...
    //jMODS:
    std::tuple<std::size_t, bool, double, double> solve();
    ...
    static Parameters default_parameters()
    {
      ...
      p.add(jNewtonSolver::default_parameters());
  ...
  private:
    ...
    private:
      ...
      std::shared_ptr<const jNonlinearVariationalSolver> _solver;
    ...
    // The Newton solver
    std::shared_ptr<jNewtonSolver> newton_solver;
